...
<head>
    ...
    <title><?php echo $project_name; ?> | Designation Edit</title>
    <script>
    function ck() {
...
<body>
    ...
    <section class="user-dashboard padding-top padding-bottom">
        <div class="container">
            <div class="row gy-5">
                ...
                $data = $link->rawQueryOne("select * from tb_business_designation where designation_Id=?", array($designation_Id));
                if ($link->count == 0) {
                    echo "Data Not Found";
                }
                ?>
    ...
    margin-top: 50px; max-width: 961px;">
                    <h4 class="title">Update Desigination</h4>
                    <form class="contact-form" name="f1" method="post" action="desigination-update-insert.php"
