...
<head>
    <meta charset="utf-8" />
    <title>Busi Nessster | Add Testimonials</title>
    ...
    function ck() {
        ...
        var e = document.f1.testimonials_Photo.value;


        if (e == 0) {
            document.getElementById("m3").innerHTML = "Upload Testimonials Photo";
            s = false;
        }
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="card-box">
                                ...
                                <div class="row">
                                    <div class="col-xl-6">
                                        <form name="f1" method="post" action="form-testimonials-insert.php"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="testimonials_Name"
                                                    id="testimonials_Name" placeholder="Enter the Testimonials Name">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control" name="testimonials_Review" rows="4"
                                                    id="editor" id="testimonials_Review"
                                                    placeholder="Enter Testimonials Review"></textarea>
