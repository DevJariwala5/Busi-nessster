...
<head>
    <meta charset="utf-8" />
    <title>Busi Nessster | Packages</title>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="form-package-update.php?package_Id=<?php echo $d['package_Id']; ?>"><input
                                                        type="button" name="edit" class="btn btn-primary"
                                                        value="Edit"></a>
                                            </td>

                                            <td><a
                                                    href="form-package-delete.php?package_Id=<?php echo $d['package_Id']; ?>"><input
