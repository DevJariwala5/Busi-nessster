            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-12">
                    <div class="account-wrapper">
                        ...
                        <form class="account-form" name="f1" method="post" action="investor-registration2.php"
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="radio" name="investor_Gender" id="investor_Gender" value="male"
                                        style="width: 4%;"> Male <td><span id="m17" style="color:red;"></span></td><br>
                                    <br>

                                    <input type="radio" name="investor_Gender" id="investor_Gender" value="female"
                                        style="width: 4%;">Female
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <textarea class="form--control" placeholder="Address" id="investor_Address"
                                        name="investor_Address"></textarea>
