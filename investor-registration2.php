...
<head>
    ...
    function ck() {
        ...
        var p = document.f1.investor_Photo.value;


        if (p == 0) {
            document.getElementById("m7").innerHTML = "Upload Investor Photo";
            s = false;
        }
                ...
                <div class="col-lg-12">
                    <div class="account-wrapper">
                        ...
                        <form class="account-form" name="f1" method="post" onSubmit="return ck();"
                            action="investor-registration-insert.php" enctype="multipart/form-data">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    ...
                                    <textarea class="form--control" name="investor_Business_Description" rows="4"
                                        ...
                                        placeholder="investor Description"></textarea>
                        ...
                        <a href="investor-login.php" class="create-account theme-four">Sign in</a>
                        <div class="shape">
