...
<head>
    ...
    <title><?php echo $project_name; ?> | Document Edit</title>
    <script>
    function ck() {
...
<body>
    ...
    margin-top: 50px; max-width: 961px;">
                    ...
                    <form class="contact-form" name="f1" method="post" action="document-update-insert.php"
                        ...
                        <img src="<?php echo $data['business_Document']; ?>" style="height:140px;width:140px">
                        <div class="form--group">
