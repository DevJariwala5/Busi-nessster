...
<head>
    ...
    <title><?php echo $project_name; ?> | Edit Business</title>
    <script>
    function ck() {
            ...
            <div class="row align-items-center gy-5">
                ...
                <div class="col-lg-12">
                    <div class="account-wrapper">
                        ...
                        <form class="account-form" name="f1" method="post" action="business-update-insert.php"
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="email" class="form--control" placeholder="Business Email"
                                        ...
                                        value="<?php echo $data['business_Email_Id'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="password" class="form--control" placeholder="Password"
                                        id="business_Password" name="business_Password"
                                        value="<?php echo $data['business_Password'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <select id="category_Name" name="category_Name" class="form--control">
                                        ...
                                        $data1 = $link->rawQuery("select * from tb_business_category");
                                        if ($link->count > 0) {
                                            foreach ($data1 as $d) {
                                        ?>
                                        <option value="<?php echo $d['category_Id']; ?>" <?php if ($d['category_Id'] == $data['category_Id']) {
                                                                                                        echo "selected";
                                                                                                    } ?>>
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <textarea class="form--control" placeholder="Address" id="business_Address"
                                        name="business_Address"><?php echo $data['business_Address']; ?></textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Contact No."
                                        id="business_Contact_No" name="business_Contact_No"
                                        value="<?php echo $data['business_Contact_No'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Year of Established"
                                        id="business_Year_Of_Established" name="business_Year_Of_Established"
                                        value="<?php echo $data['business_Year_Of_Established'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Partnership"
                                        id="business_Patnership" name="business_Patnership"
                                        value="<?php echo $data['business_Patnership'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Business Website"
                                        ...
                                        value="<?php echo $data['business_Website'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    ...
                                    <textarea class="form--control" name="business_Description" rows="4"
                                        ...
                                        placeholder="Business Description"><?php echo $data['business_Description'] ?></textarea>
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Percentage of Ownership"
                                        id="percentage_Of_Ownership" name="percentage_Of_Ownership"
                                        value="<?php echo $data['percentage_Of_Ownership'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Current Revenue"
                                        id="current_Revenue" name="current_Revenue"
                                        value="<?php echo $data['current_Revenue'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    <input type="text" class="form--control" placeholder="Percentage of growth"
                                        id="percentage_Of_Growth" name="percentage_Of_Growth"
                                        value="<?php echo $data['percentage_Of_Growth'] ?>">
                            ...
                            <div class="col-lg-6">
                                <div class="form--group">
                                    ...
                                    <img src="<?php echo $data['business_Logo']; ?>" style="height:140px;width:140px">
