...
<head>
    <meta charset="utf-8" />
    <title>Busi Nessster | Categories</title>
                                ...
                                <table id="datatable" class="table table-bordered dt-responsive nowrap"
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><a
                                                    href="form-category-update.php?category_Id=<?php echo $d['category_Id']; ?>"><input
                                                        type="button" name="edit" class="btn btn-primary"
                                                        value="Edit"></a>
                                            </td>
                                            <td><a
                                                    href="form-category-delete.php?category_Id=<?php echo $d['category_Id']; ?>"><input
