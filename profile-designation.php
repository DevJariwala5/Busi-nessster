...
<head>
    ...
    <title><?php echo $project_name; ?> | Designation</title>
    <script>
    function ck() {
        ...
        var a = document.f1.designation_Name.value;
...
<body>
                ...
                <div class="col-lg-3">
                    <div class="dashboard-sidebar">
                        ...
                        <ul class="user-dashboard-tab">
                            ...
                            <li>
                                <a href="profile-designation.php" class="active">Add Designation</a>
                            </li>
                            <li>
    ...
    margin-top: 50px; max-width: 961px;">
                    <h4 class="title">Add Desigination</h4>
                    <form class="contact-form" name="f1" method="post" action="desigination-insert.php"
                        ...
                        <div class="form--group">
                            <input type="text" class="form--control" placeholder="Designation Name"
                                name="designation_Name" id="designation_Name">
                ...
                <div class="dashborad-header">
                    <h4 class="title">All Designation</h4>
                ...
                <table class="deposit-table">
                    ...
                    <tbody>
                        ...
                        $data = $link->rawQuery("select * from tb_business_designation where business_Id='$business_Id'");
                        if ($link->count > 0) {
                            foreach ($data as $d) {
                        ?>
                        <tr>
                            ...
                            <td data-input="user">
                                <div class="user">
                                    ...
                                    <div class="content">
                                        <a
                                            href="designation-update.php?designation_Id=<?php echo $d['designation_Id'] ?>"><button
                            ...
                            <td data-input="start date">
                                <div class="content">
                                    <div class="content">
                                        <a
                                            href="designation-delete.php?designation_Id=<?php echo $d['designation_Id'] ?>"><button
                                                class="custom-button" name="submit" type="submit"
